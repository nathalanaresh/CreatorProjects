...
Call f_WriteToDriverLogFile("Test Case <4>:<Test Case 4>")
Reporter.ReportEvent micPass, "Test Case <4>:<Test Case 4>","--Started"
Call START_TEST_CASE(4,"Test Case 4")

'External Circumstances


' Covered requirement: Requirements/Create New Account/Reject non matching password

f_WriteToDriverLogFile("Requirement Covered: Requirements/Create New Account/Reject non matching password")

Reporter.ReportEvent micPass, "Requirement Covered:  Requirements/Create New Account/Reject non matching password",""

'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

'f_WriteToDriverLogFile("Test Case <4>: Step <1>: <PERFORM enter URL ACTION>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <4>: Step <1>: <Creator 2 action:PERFORM enter URL ACTION>")
...
'f_WriteToDriverLogFile("Test Case <4>: Step <2>: <VERIFY Parabank Welcome SCREEN>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <4>: Step <2>: <Creator 2 action:VERIFY Parabank Welcome SCREEN>")
...
'f_WriteToDriverLogFile("Test Case <4>: Step <3>: <CLICK Register HYPERLINK Parabank Welcome Customer Login>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <4>: Step <3>: <Creator 2 action:CLICK Register HYPERLINK Parabank Welcome Customer Login>")
...
'f_WriteToDriverLogFile("Test Case <4>: Step <4>: <VERIFY Register SCREEN>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <4>: Step <4>: <Creator 2 action:VERIFY Register SCREEN>")
...
'f_WriteToDriverLogFile("Test Case <4>: Step <5>: <FILL Signup FORM Register>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <4>: Step <5>: <Creator 2 action:FILL Signup FORM Register>")
...
step5Register_Signup_Zip_Code_TEXTBOX = 123456
...
step5Register_Signup_Phone_TEXTBOX = 123456
...
step5Register_Signup_SSN_TEXTBOX = "SSN Number"
...
step5Register_Signup_Confirm_TEXTBOX = "valid password"
...
'f_WriteToDriverLogFile("Test Case <4>: Step <6>: <CLICK RIGISTER BUTTON Register Signup>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <4>: Step <6>: <Creator 2 action:CLICK RIGISTER BUTTON Register Signup>")
...
'f_WriteToDriverLogFile("Test Case <4>: Step <7>: <VERIFY Account Created ACTION>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <4>: Step <7>: <Creator 2 action:VERIFY Account Created ACTION>")

Dim step7user_actionData
Set step7user_actionData =  CreateObject("Scripting.Dictionary")
Dim Interface_step7
Interface_step7 =  "user"
Dim step7user_actionDatamessage
Dim step7user_actionDatamessage_VALUE_TYPE
step7user_actionDatamessage = "Account Created Successfully, you are now logged in"
step7user_actionDatamessage_VALUE_TYPE = "[Value]"
step7user_actionData.Add "user_actionDatamessage",step7user_actionDatamessage
step7user_actionData.Add "user_actionDatamessage_VALUE_TYPE",step7user_actionDatamessage_VALUE_TYPE
rc = VERIFY_Account_Created_ACTION(Interface_step7,step7user_actionData)
f_WriteToDriverLogFile("<Step <7>: <Creator 2 action:VERIFY Account Created ACTION>"& StepResult(rc))
Reporter.ReportEvent rc, "<Step <7>: <Creator 2 action:VERIFY Account Created ACTION>","--" & StepResult(rc)

Call END_TEST_CASE(4,"Test Case 4")
