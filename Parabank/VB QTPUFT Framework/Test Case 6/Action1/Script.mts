...
''Test Description : "User trying to create new account by clicking Register link in Home Page. When user enters existing user name in register form then system should displays “This username already exist” and then TSID: 3."
...
Call f_WriteToDriverLogFile("Test Case <6>:<Test Case 6>")
Reporter.ReportEvent micPass, "Test Case <6>:<Test Case 6>","--Started"
Call START_TEST_CASE(6,"Test Case 6")

'External Circumstances

'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

'f_WriteToDriverLogFile("Test Case <6>: Step <1>: <PERFORM enter URL ACTION>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <6>: Step <1>: <Creator 2 action:PERFORM enter URL ACTION>")
...
'f_WriteToDriverLogFile("Test Case <6>: Step <2>: <VERIFY Parabank Welcome SCREEN>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <6>: Step <2>: <Creator 2 action:VERIFY Parabank Welcome SCREEN>")
...
'f_WriteToDriverLogFile("Test Case <6>: Step <3>: <CLICK Register HYPERLINK Parabank Welcome Customer Login>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <6>: Step <3>: <Creator 2 action:CLICK Register HYPERLINK Parabank Welcome Customer Login>")
...
'f_WriteToDriverLogFile("Test Case <6>: Step <4>: <VERIFY Register SCREEN>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <6>: Step <4>: <Creator 2 action:VERIFY Register SCREEN>")
...
'f_WriteToDriverLogFile("Test Case <6>: Step <5>: <FILL Signup FORM Register>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <6>: Step <5>: <Creator 2 action:FILL Signup FORM Register>")
...
step5Register_Signup_Username_TEXTBOX = "exist username"
...
'f_WriteToDriverLogFile("Test Case <6>: Step <6>: <CLICK RIGISTER BUTTON Register Signup>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <6>: Step <6>: <Creator 2 action:CLICK RIGISTER BUTTON Register Signup>")
...
'f_WriteToDriverLogFile("Test Case <6>: Step <7>: <VERIFY Invalid Register ACTION>")
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

f_WriteToDriverLogFile("Test Case <6>: Step <7>: <Creator 2 action:VERIFY Invalid Register ACTION>")
...
step7user_actionDataInvalid_Register = "This username already exists."
...
Call END_TEST_CASE(6,"Test Case 6")
