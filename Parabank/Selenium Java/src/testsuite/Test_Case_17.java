...
/** Conformiq generated test case
	Test Case 17
*/
public class Test_Case_17 extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Test_Case_17", "TC_Test_Case_17", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_17","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_17","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_17","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_17","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_17","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_17","Step_8");
	...
	bill_payment_service_page_init.set_Payee_Name("Payee Name");
	bill_payment_service_page_init.set_Address("Address");
	bill_payment_service_page_init.set_City("City");
	bill_payment_service_page_init.set_State("State");
	bill_payment_service_page_init.set_Zip_Code("Valid ZipCode");
	bill_payment_service_page_init.set_Phone("Phone number");
	bill_payment_service_page_init.set_Account("Account Number");
	bill_payment_service_page_init.set_Verify_Account("Account Number");
	bill_payment_service_page_init.set_Amount("Amount less than are equal to account balance");
	bill_payment_service_page_init.select_From_Account("From Account");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_17","Step_9");
	...
	bill_payment_complete_page_init.field_Bill_Payment("Bill Payment to Username in the amount of $xxx from account 12345 was successful and amount $xxx should be debit from account 12345. ");
	}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Test_Case_17");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
