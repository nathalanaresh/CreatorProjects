...
/** Conformiq generated test case
	Test Case 8
*/
public class Test_Case_8 extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Test_Case_8", "TC_Test_Case_8", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_8","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_8","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_8","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_8","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_8","Step_7");
	...
	find_transactions_page_init.verify_Find_Transactions("Find_Transactions");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_8","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_8","Step_9");
	...
	find_transactions_page_init.set_Find_By_Transaction_ID("Transaction ID");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_8","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_8","Step_11");

	Reporter.log("Step - 12- verify Transaction Result screen");

	testReport.fillTableStep("Step 12", "verify Transaction Result screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_8","Step_12");
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Test_Case_8");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
