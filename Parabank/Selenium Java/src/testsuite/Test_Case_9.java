...
/** Conformiq generated test case
	Test Case 9
*/
public class Test_Case_9 extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Test_Case_9", "TC_Test_Case_9", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_9","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_9","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_9","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_9","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_9","Step_7");

	Reporter.log("Step - 8- Verify Accounts Overview Action");

	testReport.fillTableStep("Step 8", "Verify Accounts Overview Action");

	accounts_overview_page_init.field_Account("Account Overview screen displays with Account Number,");
	accounts_overview_page_init.field_Balance("Balance, and");
	accounts_overview_page_init.field_Available_Amount("Available Amount");
	}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Test_Case_9");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
