...
/** Conformiq generated test case
	Test Case 23
*/
public class Test_Case_23 extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Test_Case_23", "TC_Test_Case_23", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_23","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_23","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_23","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_23","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_23","Step_7");
	...
	find_transactions_page_init.verify_Find_Transactions("Find_Transactions");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_23","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_23","Step_9");
	...
	find_transactions_page_init.set_Find_By_Amount(" ");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_23","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_23","Step_11");

	Reporter.log("Step - 12- Verify Transaction Error  Action");

	testReport.fillTableStep("Step 12", "Verify Transaction Error  Action");

	transaction_error__page_init.field_Error("Amount is required");
	}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Test_Case_23");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
