...
/** Conformiq generated test case
	Test Case 22
*/
public class Test_Case_22 extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Test_Case_22", "TC_Test_Case_22", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_22","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_22","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_22","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_22","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_22","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_22","Step_8");
	...
	apply_for_a_loan_page_init.set_Loan_Amount("");
	apply_for_a_loan_page_init.set_Down_Payment("[Don't Care]");
	apply_for_a_loan_page_init.select_From_Account("Existing Accounts");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_22","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_22","Step_10");

	Reporter.log("Step - 11- click Account Overview hyperlink Apply for a Loan screen");

	testReport.fillTableStep("Step 11", "click Account Overview hyperlink Apply for a Loan screen");

	apply_for_a_loan_page_init.click_Account_Overview();
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_22","Step_11");

	Reporter.log("Step - 12- Verify Account Overviews for Loan Action");

	testReport.fillTableStep("Step 12", "Verify Account Overviews for Loan Action");
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Test_Case_22");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
