...
/** Conformiq generated test case
	Test Case 6
*/
public class Test_Case_6 extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Test_Case_6", "TC_Test_Case_6", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_6","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_6","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_6","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_6","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_6","Step_7");
	...
	find_transactions_page_init.verify_Find_Transactions("Find_Transactions");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_6","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_6","Step_9");
	...
	find_transactions_page_init.set_Between("");
	find_transactions_page_init.set_And(" ");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_6","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_6","Step_11");

	Reporter.log("Step - 12- Verify Transaction Error  Action");

	testReport.fillTableStep("Step 12", "Verify Transaction Error  Action");

	transaction_error__page_init.field_Error(" From date is required. To date is required");
	}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Test_Case_6");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
