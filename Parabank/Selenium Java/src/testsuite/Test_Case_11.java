...
/** Conformiq generated test case
	Test Case 11
*/
public class Test_Case_11 extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Test_Case_11", "TC_Test_Case_11", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_11","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_11","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_11","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_11","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_11","Step_7");
	...
	find_transactions_page_init.verify_Find_Transactions("Find_Transactions");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_11","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_11","Step_9");
	...
	find_transactions_page_init.set_Between("From Date");
	find_transactions_page_init.set_And("To Date");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_11","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_11","Step_11");

	Reporter.log("Step - 12- verify Transaction Result screen");

	testReport.fillTableStep("Step 12", "verify Transaction Result screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_11","Step_12");

	Reporter.log("Step - 13- Perform Click Transaction Action");

	testReport.fillTableStep("Step 13", "Perform Click Transaction Action");

	click_transaction_page_init.field_Click("Click on the Transaction Link");

	Reporter.log("Step - 14- Verify Transaction Details Action");

	testReport.fillTableStep("Step 14", "Verify Transaction Details Action");

	transaction_details_page_init.field_Transaction_ID("Transaction ID");
	transaction_details_page_init.field_Date("Transaction Date");
	transaction_details_page_init.field_Description("Transaction Description");
	transaction_details_page_init.field_Type("Transaction Type");
	transaction_details_page_init.field_Amount("Transaction Amount");
	}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Test_Case_11");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
