...
/** Conformiq generated test case
	Test Case 20
*/
public class Test_Case_20 extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Test_Case_20", "TC_Test_Case_20", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_20","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_20","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_20","Step_4");
	...
	register_page_init.set_Username("exist username");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_20","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_20","Step_6");

	Reporter.log("Step - 7- Verify Invalid Register Action");

	testReport.fillTableStep("Step 7", "Verify Invalid Register Action");

	invalid_register_page_init.field_Invalid_Register("This username already exists.");
	}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Test_Case_20");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
