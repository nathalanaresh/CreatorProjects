...
/** Conformiq generated test case
	Test Case 13
*/
public class Test_Case_13 extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Test_Case_13", "TC_Test_Case_13", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_13","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_13","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_13","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_13","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_13","Step_7");
	...
	find_transactions_page_init.verify_Find_Transactions("Find_Transactions");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_13","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_13","Step_9");
	...
	find_transactions_page_init.set_Find_By_Date("Date(MM-DD-YYYY)");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_13","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_13","Step_11");

	Reporter.log("Step - 12- verify Transaction Result screen");

	testReport.fillTableStep("Step 12", "verify Transaction Result screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_13","Step_12");
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Test_Case_13");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
