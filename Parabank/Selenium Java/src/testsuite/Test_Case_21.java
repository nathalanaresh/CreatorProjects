...
/** Conformiq generated test case
	Test Case 21
*/
public class Test_Case_21 extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Test_Case_21", "TC_Test_Case_21", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_21","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_21","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_21","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_21","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_21","Step_7");

	Reporter.log("Step - 8- verify Transfer Funds screen");

	testReport.fillTableStep("Step 8", "verify Transfer Funds screen");

	transfer_funds_page_init.verify_Amount("Amount");
	transfer_funds_page_init.verify_From_Account("From_Account");
	transfer_funds_page_init.verify_To_Account("To_Account");
	transfer_funds_page_init.verify_TRANSFER("TRANSFER");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_21","Step_8");
	...
	transfer_funds_page_init.set_Amount("Amount");
	transfer_funds_page_init.select_From_Account("From Account");
	transfer_funds_page_init.select_To_Account("To Account");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_21","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_21","Step_10");
	...
	bill_payment_complete_page_init.field_Bill_Payment("Amount $XXX has been transferred from account #AAA to account #BBB. ");
	}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Test_Case_21");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
