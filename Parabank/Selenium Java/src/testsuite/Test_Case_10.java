...
/** Conformiq generated test case
	Test Case 10
*/
public class Test_Case_10 extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Test_Case_10", "TC_Test_Case_10", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_10","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_10","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_10","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_10","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_10","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_10","Step_8");
	...
	bill_payment_service_page_init.set_Verify_Account("non matching Account number");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_10","Step_9");
	...
	bill_payment_complete_page_init.field_Bill_Payment("The account numbers do not match");
	}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Test_Case_10");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
