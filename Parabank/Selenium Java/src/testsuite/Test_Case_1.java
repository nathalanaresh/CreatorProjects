...
/** Conformiq generated test case
	Test Case 1
*/
public class Test_Case_1 extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Test_Case_1", "TC_Test_Case_1", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_1","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_1","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_1","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_1","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_1","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_1","Step_8");
	...
	bill_payment_service_page_init.set_Amount("Amount greater than the account balance");
	bill_payment_service_page_init.select_From_Account("From Account");
	getScreenshot(driver,Configurations.screenshotLocation , "Test_Case_1","Step_9");
	...
	bill_payment_complete_page_init.field_Bill_Payment("Bill Pay Amount should be less than the account balance ");
	}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Test_Case_1");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
