...
public class TestReport {
	...
	public void createTesthtmlHeader(StringBuilder overallTestData){
	...
	public void generateGeneralInfo(StringBuilder overallTestData, String sTestCaseName, String sTestCaseID, String result, float exeTime) {
		...
		overallTestData.append("<TD COLSPAN=3 CLASS=fieldvalue>"+Constants.projectName+"</TD>\n");
	...
	public void writeTestReporthtml(StringBuilder overallTestData, String testCaseid) throws IOException {
		File outFile = new File(Constants.htmlOutPath);

		if(!outFile.exists()){
			outFile.mkdirs();
			Writer testFile = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(Constants.htmlOutPath+ testCaseid+".html"), "UTF-8"));
			try {
